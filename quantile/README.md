...
- For Dolci Instruct, we release the equivalent pre-computed quantile subsets for **RDS+** and **LESS** under [Harvard-DCML/tis-dolci-quantile-datasets-Llama-2-7b-hf](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-Llama-2-7b-hf), and for **EMBED** under [Harvard-DCML/tis-dolci-quantile-datasets-gtr-t5-base](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-gtr-t5-base).

- We also release additional Dolci Instruct distance quantiles for **RDS+** and **LESS** for the other base models under [Harvard-DCML/tis-dolci-quantile-datasets-Llama-3.2-3B](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-Llama-3.2-3B), [Harvard-DCML/tis-dolci-quantile-datasets-Qwen3-4B-Base](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-Qwen3-4B-Base), [Harvard-DCML/tis-dolci-quantile-datasets-SmolLM3-3B-Base](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-SmolLM3-3B-Base), and [Harvard-DCML/tis-dolci-quantile-datasets-Olmo-3-1025-7B](https://huggingface.co/datasets/Harvard-DCML/tis-dolci-quantile-datasets-Olmo-3-1025-7B), respectively.

- The examples below use `Harvard-DCML/tulu-v2-197K-processed` as the full processed training dataset; for Dolci Instruct, use the equivalent full processed dataset, `Harvard-DCML/dolci-instruct-sft-200K-processed`.
